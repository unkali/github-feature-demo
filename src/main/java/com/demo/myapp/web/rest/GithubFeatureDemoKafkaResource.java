...
@RestController
@RequestMapping("/api/github-feature-demo-kafka")
public class GithubFeatureDemoKafkaResource {

    private final Logger log = LoggerFactory.getLogger(GithubFeatureDemoKafkaResource.class);
    ...
    public GithubFeatureDemoKafkaResource(@Qualifier(KafkaSseProducer.CHANNELNAME) MessageChannel output) {
        this.output = output;
    }
